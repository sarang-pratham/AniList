...
const Navbar = () => {
  return (
    <nav className='bg-rich-black text-white flex justify-between items-center p-3'>
        ...
        <button className='p-2 hover:bg-flame-orange border border-flame-orange rounded px-6 py-2 flex items-center text-xl' title='Suggest random anime'><ion-icon name="shuffle"></ion-icon></button>
    </nav>
  )
}
